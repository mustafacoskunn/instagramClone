package ornek.uygulama.com.instagramklon.Like;
...
public class LikeActivty extends AppCompatActivity {
    private  static final int ACTIVTY_NUM=3;
    @Override
    ...
    private void BottomNavigationArayuz(){
        ...
        BottomNavigationViewHelper.enableNavigation(LikeActivty.this,bottomNavigationViewEx);
